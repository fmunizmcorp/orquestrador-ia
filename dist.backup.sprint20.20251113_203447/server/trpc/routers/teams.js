...
import { optionalPaginationInputSchema, createPaginatedResponse, applyPagination, } from '../../utils/pagination.js';
...
export const teamsRouter = router({
    ...
    create: publicProcedure
        ...
        try {
            ...
            if (!teamId) {
                ...
                throw createStandardError('INTERNAL_SERVER_ERROR', ErrorCodes.INTERNAL_DATABASE_ERROR, 'Falha ao criar equipe no banco de dados', {
            ...
            if (!team) {
                throw createStandardError('INTERNAL_SERVER_ERROR', ErrorCodes.INTERNAL_DATABASE_ERROR, 'Equipe criada mas não encontrada', {
                    context: { teamId },
    ...
    addMember: publicProcedure
        ...
        try {
            ...
            if (!memberId) {
                throw createStandardError('INTERNAL_SERVER_ERROR', ErrorCodes.INTERNAL_DATABASE_ERROR, 'Falha ao adicionar membro na equipe', {
