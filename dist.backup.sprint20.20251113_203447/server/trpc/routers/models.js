...
import { createStandardError, handleDatabaseError, handleGenericError, ErrorCodes, notFoundError, } from '../../utils/errors.js';
...
export const modelsRouter = router({
    ...
    create: publicProcedure
        ...
        try {
            ...
            if (!modelId) {
                throw createStandardError('INTERNAL_SERVER_ERROR', ErrorCodes.INTERNAL_DATABASE_ERROR, 'Falha ao criar modelo', {
    ...
    createSpecialized: publicProcedure
        ...
        try {
            ...
            if (!aiId) {
                throw createStandardError('INTERNAL_SERVER_ERROR', ErrorCodes.INTERNAL_DATABASE_ERROR, 'Falha ao criar IA especializada', {
                    context: { name: input.name },
    ...
    discoverModels: publicProcedure
        ...
        try {
            ...
            try {
                ...
                const discoveredModels = (data.data || []).map((model) => ({
                    id: model.id,
