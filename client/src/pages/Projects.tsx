    ...
    <div className="p-6">
      ...
      {isLoading ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-4">Carregando projetos...</p>
        </div>
          ...
          {filteredProjects.map((project: any) => (
            <div key={project.id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex-1">{project.name}</h3>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
              <div className="space-y-4 p-6 overflow-y-auto flex-1">
                ...
                <div>
                  <label htmlFor="teamId" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
                    Equipe (opcional)
                  </label>
                  <select
                    id="teamId"
