...
export const CollaborationPanel: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-30">
      ...
      {/* Expanded Panel */}
      {isExpanded && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-80 max-h-96 overflow-hidden flex flex-col">
          {/* Header */}
          ...
          {/* Users List */}
          <div className="p-4 border-b border-gray-200 dark:border-gray-700 max-h-48 overflow-y-auto">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            {recentEvents.length === 0 ? (
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center py-4">No recent activity</p>
            ) : (
              <div className="space-y-2">
                {recentEvents.map((event, index) => (
                  <div key={index} className="text-xs text-gray-600 dark:text-gray-300 bg-gray-50 rounded p-2">
          ...
          {/* Footer */}
          <div className="border-t border-gray-200 px-4 py-2 bg-gray-50 dark:bg-gray-900">
